...
(function () {
  ...
  var ANON_GROUP_NAME = '🎭 化妆间';            // 匿名大厅（聊满 50 楼由管家拉进去，解锁逻辑在 dm_generator）
  ...
  // 直接 slice(0,16) 会把第三个名字掐成半个（「纪司柏、楚何河、祈」），难看
  ...
  async function fetchPool(force) {
    ...
    try {
      ...
      if (Array.isArray(rows)) { _pool = rows; console.log('[SB-S v4] lux pool: ' + rows.length + ' items'); }
    } catch (e) { console.warn('[SB-S v4] lux pool fetch failed', e); }
  }
  ...
  async function fetchExperiences(force) {
    ...
    try {
      ...
      var rows = await srvFetch('sb_experiences_classic?active=eq.true&order=created_at.desc&limit=300');
      if (Array.isArray(rows)) {
        _exps = rows; console.log('[SB-S v4] experiences: ' + rows.length);
        // 首屏是兜底那几条撑的，服务器货到了要就地重抽一手（Elite 页开着才管）
        if (currentPage === 'elite') { _expShow = []; openElite(); }
      }
    } catch (e) { _expsAt = 0; console.warn('[SB-S v4] experiences fetch failed', e); }   // 失败别占10分钟冷却：下次进页立刻能重试（国内连 supabase 常抽风）
  }
  ...
  var EXP_FALLBACK = [
    ...
    // ▼ 服务器货烤进本地（连不上 supabase 的玩家也有得抽有得换）——从 sb_experiences_classic 等距取样 18 条，id 与服务器一致（买过的照样被 seenExp 滤掉）
    { id: "1", title: "拍卖行夜场：代持号牌", location: "拍卖行 · 夜场", price: 120000, image_url: '',
      blurb: "他把号牌塞进你手里：\"看中什么就举，别看价格。\"", seed: "（先想再写。真实的夜场拍卖：举牌的号牌要提前登记保证金，落槌价之外还要加约 15% 买家佣金；真正的大买家坐侧翼或走电话委托，很少自己举。肯把号牌交到身边女伴手上的人，全场都读得懂这个宣言。开写前想清楚：①陪她来的是谁？他塞牌给她的那句话、加价的节奏、被人回头看时的反应，必须长在他的人设上（独自来=她自己举牌，写成一个人的加冕）；②独家爽点＝用别人的钱抬价时指尖发麻的权力错觉，写进她的身体反应，不要只写场面；③拍到她真正心动的那件、拍卖师第二次落槌前停笔——举不举，{{user}} 自己定。铁律：奢华＝纯粹的享受，禁止空虚、代价、清醒旁白。恢复扮演，从她被引进侧翼席、号牌压在掌心的凉写起。）" },
    { id: "3", title: "闭店私人试衣：整层楼为你开灯", location: "CBD 旗舰店", price: 45000, image_url: '',
      blurb: "晚上九点的旗舰店，灯只为一个人亮着。", seed: "（先想再写。闭店试衣是顶级门店的隐藏服务：晚九点整层清场，专属顾问按她的尺码把当季高定预挂在试衣间外，改衣师随侍待改，试衣间里备着她上次随口提过的那款气泡水。想清楚：①他坐在沙发上看她换装的方式必须是\"他\"——审艺术品式、报出每件价格式、还是一言不发只转着杯子？（独自来＝整层楼和顾问都是她一个人的，写成登基）；②独家爽点＝空旷商场里灯只为一人亮的尊贵感，以及镜子里那个陌生的自己；③他挑出那件最出格的裙子递过来时停笔——穿不穿、让不让他进试衣间，{{user}} 说了算。铁律：物欲＝快乐，禁清醒旁白。恢复扮演，从专属电梯门在空荡的大堂打开写起。）" },
    { id: "5", title: "郊区庄园：暴雨封了路", location: "近郊 · 私人庄园", price: 90000, image_url: '',
      blurb: "雨太大了，今晚谁都走不了。", seed: "（先想再写。真实质感：这种庄园离市区一个半小时，管家和厨师是常驻的，主人来不来都在；暴雨天山路会封，手机信号只剩一格，壁炉是真的要人添柴的。\"回不去了\"这件事对两个人是同一句话、两种意思。想清楚：①被困住之后他的第一反应按人设是什么——打电话安排、若无其事倒酒、还是终于放下了什么？②独家爽点＝与世隔绝的独占感，外面雨越大里面越安全，写进声音（雨、柴、脚步在木地板上）；③管家道过晚安退下、整栋房子只剩两个人时停笔。铁律：纯粹享受，禁空虚。恢复扮演，从车轮碾过积水、铁门在雨幕里打开写起。）" },
    { id: "7", title: "私人包机：不带行李去三亚", location: "机场 FBO → 三亚", price: 200000, image_url: '',
      blurb: "\"什么都不用带。到了那边全都有。\"", seed: "（先想再写。真实的公务机流程：不走航站楼，从 FBO 专用通道进，安检十分钟，行李直接上机；机上没有安全演示广播，空乘只有一位，问的第一句是喝什么。所谓\"不带行李\"是真的——落地后一整套是提前送到酒店的。想清楚：①他说\"什么都不用带\"时按人设是随口一句还是早就安排好了？他在机上做什么——办公、睡觉、还是全程看她？②独家爽点＝被彻底接管的失重感，她唯一要做的决定就是喝什么；③落地后车门打开、热浪扑进来那一刻停笔。铁律：纯粹享受，禁\"这一切要付出什么代价\"。恢复扮演，从她空着手走过 FBO 那条铺了地毯的通道写起。）" },
    { id: "9", title: "老洋房私厨：没有招牌，只认人", location: "老城区 · 老洋房", price: 22000, image_url: '',
      blurb: "导航到不了，门口没有牌子，敲三下。", seed: "（先想再写。真实的私厨规矩：一天只做一桌，菜单当天定，老板会亲自出来讲每道菜的来历；没有招牌不是噱头，是执照和熟客制的现实；能带谁来吃是一种资格。想清楚：①老板认不认识他？这一点按人设决定了整晚的调子（被叫出名字＝他常带人来，反之＝他为她破了例）；②独家爽点＝隐秘、只有一桌、以及\"能进这道门的人不多\"，写进具体的一道菜和她的味觉；③上到最后一道、老板退出去把门带上时停笔。铁律：纯粹享受，禁写成美食测评。恢复扮演，从他在一条没有路灯的弄堂里停下、抬手敲门写起。）" },
    { id: "11", title: "主厨上门：只做两人份", location: "他的公寓", price: 32000, image_url: '',
      blurb: "整个厨房今晚只为两个人开火。", seed: "（先想再写。真实质感：主厨带自己的刀和两个助手，提前四小时进场，用的是他家那口从没开过火的灶；菜单前一周就定了，会避开她说过不吃的东西——这说明有人记了。上菜的节奏很慢，中间的空档才是重点。想清楚：①菜单避开的那样东西是什么，他是怎么知道的？这一点按人设写；②独家爽点＝顶级的手艺被压缩成只给两个人的私密，以及厨房里有人在忙、餐桌上却安静得能听见呼吸；③甜点上完、主厨道别关门、屋里只剩他们两个时停笔。铁律：纯粹享受，禁写成菜谱。恢复扮演，从门铃响、三个穿白色厨师服的人搬着箱子进来写起。）" },
    { id: "13", title: "午夜包场：无边泳池", location: "酒店顶层泳池", price: 28000, image_url: '',
      blurb: "十一点后清场。整片水面只有你一个人。", seed: "（暂停角色扮演，先想再写。真实质感：酒店顶层泳池夜里包场要提前和管家谈，救生员必须在场但会站得很远；无边泳池的边缘看过去是和城市天际线接在一起的，水是恒温的，夜里比空气暖；水下有灯，人在水里是发亮的。想清楚：①他下不下水？按人设——陪她游、坐在池边看、还是根本没来只是买了单？②独家爽点＝整片水只属于一个人的独占感，以及水温和夜风的温差写在皮肤上；③她游到池边、手扶在那道\"没有边\"的边缘上、整座城市在下面时停笔。铁律：纯粹享受，禁孤独感。恢复扮演，从电梯直达顶层、水面的反光打在天花板上写起。）" },
    { id: "15", title: "会所牌局：她坐在他身后", location: "会员制会所 · 内厅", price: 100000, image_url: '',
      blurb: "\"你就站我后面。今晚不用说话。\"", seed: "（暂停角色扮演，先想再写。真实质感：这种局不写在任何日程上，筹码不当场结算；带人进内厅是要报备的，能站在谁身后是一种位置；桌上的人不看她，但每个人都注意到了她。她的存在本身就是他牌面的一部分。想清楚：①他让她站在身后的理由按人设是什么——镇场、炫耀、还是不放心把她留在外面？他输钱时是什么反应？②独家爽点＝作为\"他的一部分\"被展示的隐秘权力感，以及全场没人跟她说话却人人都在计算她；③一局结束、有人第一次抬头正眼看她并开口时停笔。铁律：纯粹享受，禁被物化的委屈感——她享受这个位置。恢复扮演，从内厅那道门被推开、烟味和筹码声一起涌出来写起。）" },
    { id: "17", title: "午夜游艇：船员假装看不见", location: "江面 · 私人游艇", price: 110000, image_url: '',
      blurb: "船开出去之后，就只剩水声了。", seed: "（暂停角色扮演，先想再写。真实质感：私人游艇的船员受过训练——在场但不在，问什么都答\"好的\"，看到什么都没看到；江心夜里很黑，岸上的灯是一整条发光的线；甲板夜里凉，船一停下来就能听见水拍船身的声音。想清楚：①他把船开到江心停下的动机按人设是什么？他和船长熟不熟？②独家爽点＝在城市正中央却完全不被看见的悖论，以及\"有人在场却当作没有\"这件事本身的刺激；③船停稳、船员退到舱内、甲板上只剩他们两个时停笔。铁律：纯粹享受，禁羞耻。恢复扮演，从码头的缆绳被解开写起。）" },
    { id: "19", title: "清晨的独享早餐", location: "珠宝店 · 开门前", price: 26000, image_url: '',
      blurb: "店还没开门。桌子摆在柜台中间。", seed: "（暂停角色扮演，先想再写。真实质感：这是品牌给顶级客人的仪式性服务——开门前一小时，把早餐桌摆在展柜之间，全店只有一个店长和一个侍者；这一小时里所有柜台都是开着的，她可以随便试；重点从来不是那顿早餐，是\"整间店在你一个人手里\"的那一小时。想清楚：①这个安排是谁做的、他到底来没来？（没来才是更狠的一手——他让她一个人享受这个）；②独家爽点＝清晨的空店、展柜的冷光、和一杯还烫的咖啡放在玻璃柜台上那种不该有的随意；③她把某一件戴上、看着镜子里的自己、店长在身后说\"这件很适合您\"时停笔。铁律：纯粹享受，禁孤独。恢复扮演，从卷帘门为她一个人升起写起。）" },
    { id: "21", title: "马场私教：他托着你的脚踝上马", location: "近郊 · 私人马场", price: 36000, image_url: '',
      blurb: "第一次上马，所有人都得被人托一把。", seed: "（暂停角色扮演，先想再写。真实的马术入门：马鞍很高，新人上马一定要有人托左脚踝往上送；马能闻出人紧张，人越僵它越不听话；教练会先牵着走二十分钟不让你自己控缰。马房的味道是干草、皮革和马汗混在一起的，衣服上会留一整天。想清楚：①托她脚踝上马的是教练还是他？他自己会不会骑——这一点按人设决定了整场的权力关系（他骑得好＝他在教她，他不骑＝他在看她）；②独家爽点＝大腿内侧被马鞍磨到的酸、被一个庞然大物驮着走的失控感、和落地时腿软那一下；③她第一次自己控住缰绳、马听话地转过来、她回头找他的目光时停笔。铁律：纯粹享受，禁写成教学。恢复扮演，从马房门口那股干草味写起。）" },
    { id: "23", title: "周日清晨：那台从不上牌的车", location: "车库 → 环城公路", price: 0, image_url: '',
      blurb: "\"这台我一年开不了三次。今天带你去兜一圈。\"", seed: "（暂停角色扮演，先想再写。真实质感：收藏级的车不上牌不上路，养在恒温车库里，每周有人来打火十分钟；肯开出去＝一种给你看的仪式。清晨五点的环城路没有车，这种车的声音在空路上是会回响的。开这种车的人手会抖一点，不是紧张，是兴奋。想清楚：①这台车对他意味着什么、他为什么选今天开出来？按人设写；②独家爽点＝引擎点火那一下整个车库的共鸣、加速时她被压进椅背、以及天完全亮之前那种偷来的时间感；③他把车停在高架尽头、熄火、天刚亮时停笔。铁律：纯粹享受，禁写成车评。恢复扮演，从车库的灯一排排亮起来写起。）" },
    { id: "25", title: "私人影院：一部还没上映的片子", location: "会所 · 放映厅", price: 24000, image_url: '',
      blurb: "拷贝是他要来的。全国只有几个人看过。", seed: "（暂停角色扮演，先想再写。真实质感：这种放映厅十几个座位，沙发是躺的，有专人送吃的；片源多半是圈子里流出来的送审版或电影节拷贝，画面角上可能还带水印和时间码。放映时厅里只有他们两个，屏幕的光会一直变，人的脸在那个光里是忽明忽暗的。想清楚：①这拷贝他是怎么弄来的、他在不在乎片子本身？按人设——真影迷会讲导演，纯炫耀的会一直看手机；②独家爽点＝黑暗里两个人挨着、屏幕的光打在脸上、以及\"全国没几个人看过\"的隐秘特权；③片子演到某个让她心里一动的地方、她转头发现他其实一直在看她时停笔。铁律：纯粹享受。恢复扮演，从放映厅的灯一点点暗下去写起。）" },
    { id: "27", title: "赛马日：包厢、帽子、和他的马", location: "赛马场 · 会员包厢", price: 75000, image_url: '',
      blurb: "\"三号那匹是我的。押它。\"", seed: "（暂停角色扮演，先想再写。真实质感：赛马日的会员看台有着装要求，女士戴帽子；马主有专属包厢和下场通道，赛后能进围场摸自己的马；一场比赛只有一两分钟，前后的社交才是全天的重点；输赢对马主来说不是钱，是面子。想清楚：①他是马主还是被邀请的客人？他的马赢了还是输了——**这一点让 AI 自己定**，输了之后他的反应最能看出人设；②独家爽点＝她戴着帽子被一堆陌生人打量、以及一分半钟里全场的声音；③比赛结束、他带她走那条马主专用通道下场、马鼻子喷出的热气扑到她手上时停笔。铁律：纯粹享受。恢复扮演，从她在包厢门口被要求把帽子戴正写起。）" },
    { id: "29", title: "闭馆之后：当代艺术私人导览", location: "美术馆", price: 40000, image_url: '',
      blurb: "策展人为你一个人讲了四十分钟。", seed: "（暂停角色扮演，先想再写。真实质感：闭馆后的私览要通过赞助人或藏家的关系约，策展人亲自带；当代艺术的私览和古典完全不同——策展人会讲创作背景和圈内八卦，也会直说\"这件我其实不喜欢\"；空馆里脚步声很响，作品在没有人群的时候会变得逼人。想清楚：①带她来的人是这里的赞助人吗？他对艺术是真懂、装懂、还是坦率承认不懂？按人设；②独家爽点＝一件巨大的作品前只站着两三个人、以及策展人说漏嘴的那句圈内话；③在某件作品前她停住不走、被问\"你看到什么了\"时停笔——她的答案交给 {{user}}。铁律：纯粹享受，禁写成艺术评论。恢复扮演，从卷帘门在闭馆后为他们重新升起写起。）" },
    { id: "31", title: "委托：去他家族聚会演女朋友", location: "他家 · 家宴", price: 150000, image_url: '',
      blurb: "\"演我女朋友。演得像一点，加钱。\"", seed: "（暂停角色扮演，先想再写。真实质感：这是报酬最高也最难演的委托——一屋子人，每个人都在打量她，长辈会问学历、家里做什么、什么时候结婚；他要全程配合演宠溺男友，两个人的口供必须提前对过（怎么认识的、多久了）；难的不是骗过别人，是两个人在演的过程中自己会晃神。想清楚：①他为什么要演这一场——退相亲、堵亲戚的嘴、气前任、还是给长辈一个交代？按人设定，这决定了他演得多用力；②独家爽点＝假戏做全套时那种\"这一刻好像是真的\"的错位，写进一个具体的动作（他替她夹菜、在桌下按住她的手、替她挡酒）；③某个长辈说了一句让两个人同时愣住的话时停笔。铁律：纯粹享受，禁苦情、禁\"她只是个道具\"的自伤。恢复扮演，从车停在门口、他侧过头说\"记住，我们认识两年了\"写起。）" },
    { id: "33", title: "蒙眼上车：不许问去哪", location: "？", price: 70000, image_url: '',
      blurb: "\"手机给我。眼睛闭上。落地你就知道了。\"", seed: "（暂停角色扮演，先想再写。真实质感：这种局的乐趣全在信息差——她能感觉到车开了多久、上没上高速、有没有过安检、空气的温度和味道在变；蒙眼状态下听觉和嗅觉会被放大到不正常；真正的高潮不是目的地，是\"我完全不知道接下来会发生什么\"的那一路。想清楚：①目的地是什么——**让 AI 自己定**，但必须配得上这个铺垫（另一座城市/一场只为她办的什么/一个她随口提过一次的地方）；②独家爽点＝被剥夺视觉之后其他感官的过载，写进具体的：座椅的皮味、他手掌的温度、突然变冷的空气；③眼罩被摘下来、光涌进来那一刻停笔——她看到了什么，交给 {{user}} 自己看。铁律：纯粹享受。恢复扮演，从他伸手过来、她犹豫了半秒才闭上眼睛写起。）" },
    { id: "35", title: "医美：不用排队的那位医生", location: "医美一条街 · 私人诊所", price: 38000, image_url: '',
      blurb: "\"他档期排到年底。我让他给你留了周四下午。\"", seed: "（暂停角色扮演，先想再写。真实质感：顶级医生的号是真的抢不到，能插队本身就是硬通货；面诊时他会拿着灯照着你的脸讲结构，说的话很技术、一点不温柔（\"这里骨量不够\"\"你笑的时候这块提不起来\"），被这样赤裸地评估是一种奇特的体验；打完针脸会僵，恢复期几天不能大笑。想清楚：①这个号是谁弄来的、他有没有陪她来？陪来的话他在诊室里说不说话——按人设（有的男人会替她做决定，有的会说\"她自己定\"）；②独家爽点＝被专业地、毫不留情地分析一张脸，和\"我可以随时把它调整成我想要的样子\"的掌控感；③针推进去之前那一秒的凉，或者出诊所时她对着车窗照自己时停笔。铁律：纯粹享受，禁容貌焦虑说教、禁\"这是在讨好男人\"的批判。恢复扮演，从她坐进那张椅子、灯打到脸上写起。）" },
  ];
  ...
  async function fetchRank(force) {
    ...
    _rankAt = Date.now();
    try {
      var rows = await srvFetch('sb_rank_classic?order=amount.desc&limit=100');   // 群众要求加位：25 → 干脆 100（瓶颈在这，不在渲染）
      if (Array.isArray(rows)) {
        _rank = rows;
        if (currentPage === 'board:sb') openBoard('sb');   // 榜单页开着 → 真人数据到了就重画
      }
    } catch (e) { console.warn('[SB-S v4] rank fetch failed', e); }
  }
  ...
  async function fetchOfficialPost() {
    ...
    try {
      var rows = await srvFetch('sb_config?key=eq.akuma_post_classic&select=value');
      if (rows && rows[0] && rows[0].value) {
        var ov = JSON.parse(rows[0].value);
        _akOfficial = Array.isArray(ov) ? ov : [ov];
      }
    } catch (e) { console.warn('[SB-S v4] official post cfg fetch failed', e); }
  }
  async function fetchGlobalPosts(force) {
    ...
    try {
      var rows = await srvFetch('sb_posts_classic?order=created_at.desc&limit=200');   // 楼太热，60条只够顶楼10个瓜（Akuma的帖被顶没了群众有意见）
      if (Array.isArray(rows)) {
        _gposts = rows;
        if (currentPage === 'board:gossip') openBoard('gossip');   // 姐妹楼开着 → 真人帖到了就重画
      }
    } catch (e) { console.warn('[SB-S v4] global posts fetch failed（表没建/联机关了都会走这里，不影响本体）', e); }
  }
  ...
  async function reportRank() {
    ...
    try {
      await srvFetch('sb_rank_classic', { method: 'POST', prefer: 'resolution=merge-duplicates', body: { token: c.token, handle: c.handle, amount: bal, blurb: blurb } });
      if (offshore > 0) toast('info', '🏝️ 应您的税务顾问建议，超出 ￥10 亿的 ' + fmtCNY(offshore) + ' 已自动转入您的开曼群岛离岸账户。榜单仅展示在岸资产——低调，是顶级富豪最后的奢侈品。');
      toast('success', '⬆ 已上榜：' + c.handle + ' ' + fmtCNY(bal));
        ...
        b.addEventListener('click', function () {
          ...
          Promise.resolve(ensureIdentity()).then(function (c) {
            ...
            panelPrompt('回一句（署名 @' + c.handle + '，全服可见）：', '').then(function (txt) {
              ...
              if (!txt) return;
              b.textContent = '⏳ 发送中…';
              srvFetch('sb_posts_classic', { method: 'POST', body: { token: c.token, handle: c.handle, content: txt, parent_id: gid } })
    ...
    function submitGossip(isGlobal) {
      ...
      if (isGlobal) {
        Promise.resolve(ensureIdentity()).then(function (c) {
          ...
          srvFetch('sb_posts_classic', { method: 'POST', body: { token: c.token, handle: c.handle, content: txt } })
  ...
  } catch (e) {}  // 🎼 音乐（来自UWU）：QR 栏第二个按钮，手机没开也能放歌。
