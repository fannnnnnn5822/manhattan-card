...
var VOICES = {
  ...
  'Akuma': 'Akuma，S市sugar圈绝对顶端SB、SugarSecret论坛人气王。从SD视角看：她是所有金主的终极挑战，价格不固定取决于你是谁。茶里茶气emoji狂魔(🥺💕😋)。对User态度取决于出手——出手大方就给上课，出手小气连回都不回。如果User和苏念有关系，她会给情报但不免费——有时候要一顿饭有时候要一个人情。她给的情报从来没有错过。',
};
...
async function generateOnce(sb, plot, n, reason, strict) {
  ...
  var sys1 =
    ...
    '反应按人设——沈冰月不动声色收下，隔天挑一个更贵的发回来（她知道自己值这个价）；苏念第一反应是推辞，推完又小声问是不是真的；纪思瑶惊喜表演得满分，紧接着加码提第二件；叶知秋根本读不懂圈内暗示，真心实意道谢，谢得 User 心虚；林也看笑话"你也有今天"；方屿冷一句"这个牌子她上个月收过"。\n' +
  ...
  var tail = soloLock
    ...
    : strangerOnly
      ? '只生成 1 个全新陌生SB的开场：先输出他的 名字|tag|标签 行，紧接着 1-2 行他主动发来的私信（换着花样来别撞原型，他还不认识 User、只是在论坛看到他的帖子主动私信）。绝不让任何已有联系人出现、绝不续接任何已有对话、绝不替 User 说话。每条一行 名字|类型|内容，不要写别的。'
...
async function handleAdComments(p) {
  ...
  try {
    ...
    var sys = isGossip ? sysGossip :
      '你是 S市 sugar 圈地下论坛 SugarSecret™ 招聘版的评论区。一个金主(User)刚挂了一条帖子，生成网友评论。\n' +
      '【评论区生态，混着来】油腻或高冷的SB搭讪 / 同行金主拉踩吃瓜传经验 / 骗子SB抬杠 / 路人抖机灵 / 拿版规开玩笑的老哥；' +
